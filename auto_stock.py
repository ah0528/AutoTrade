...
myToken = 'xoxb-2788648796128-2777574821169-JiGKGEpIueYNNo7s20xDjzbY'
...
def get_target_price(code):
    ...
    try:
        ...
        target_price = today_open + (lastday_high - lastday_low) * 0.5  # 얼마나 공격적으로??   int.
        return target_price
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A252670', 'A401470', 'A251340', 'A400970']    # 종목 코드(ETF or 개별 종목) 삽입 필수!! str.
        bought_list = []     # 매수 완료된 종목 리스트
        target_buy_count = 4 # 매수할 종목 수    int.
        buy_percent = 0.25  # 가용 자금에서 몇 % 살건지?  int.
